...
final class MapController
{
    ...
    {
        Http::json(GeoService::storeSettings());
    }
    ...
    public static function updateSettings(Request $req): void
    {
        ...
        Http::json(GeoService::saveStoreSettings($fields));
    }
    ...
    public static function list(Request $req): void
    {
        ...
        $cond = 'o.created_at >= ? AND o.created_at < (? + INTERVAL 1 DAY) AND o.delivery_address IS NOT NULL';
        $params = [$from, $to];
        if ($platform !== null) {
            $cond .= ' AND o.platform = ?';
            $params[] = $platform;
        ...
        $store = GeoService::storeSettings();
    ...
    public static function backfill(Request $req): void
    {
        ...
        Http::json(GeoService::backfill($limit));
    }
}
